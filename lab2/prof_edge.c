...
static inline void func(int cond1, int cond2, int cond3) {
  int i;
  // keep track of sources we're coming from to count when arriving
  // no need to track ones leading to end, or false as they can be concluded others
  // probably not the "official" way to do this but I couldn't decipher that way
  int e0, e2 = 0; 
